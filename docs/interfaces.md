...
| DRV8231A x3 | Per-driver IN1/IN2, VREF and IPROPI circuits; OUT1/OUT2 to stationary coil | PWM/decay mode, current regulation/scaling, wake latency and external shutdown path |
...
left/middle/right IN1/IN2 pairs and GPIO10-13 to ADC_CS, SPI_MOSI, SPI_SCLK and
SPI_MISO respectively. Remaining allocation is open; these choices are provisional.
...
Specify input pulldowns and a hardware timeout/disable path before layout;
internal protection alone does not detect stale firmware commands.
