...
The motherboard has **273 BOM components**, all with catalog IDs, MPNs and
...
schematic pages, 276 BOM components and 320 footprints. Encoder review outputs
...
The additional checker verifies 195 critical power pin connections, 317 motherboard footprint
